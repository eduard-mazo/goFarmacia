...
-- Tables that depend on vendedors and clientes
create table
    public.facturas (
        id bigserial not null,
        created_at timestamp with time zone null,
        ...
        fecha_emision timestamp with time zone null,
...
-- Tables that depend on facturas and productos
create table
...
-- Tables that depend on proveedors
create table
    public.compras (
        id bigserial not null,
        created_at timestamp with time zone null,
...
-- Tables that depend on compras and productos
create table
...
-- Tables that depend on facturas, productos, and vendedors
create table
