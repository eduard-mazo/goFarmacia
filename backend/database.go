...
func (d *Db) initDB() {
	...
	d.RemoteDB, err = d.NewRemoteDB(os.Getenv("REMOTE_DB_CONN"))
...
func (d *Db) isRemoteDBAvailable() bool {
	...
	return d.RemoteDB.Ping(context.Background()) == nil
}
...
func (d *Db) AutoMigrate() error {
	...
	if err != nil {
		return fmt.Errorf("Error al crear tablas en Base de datos local SQLite: %w", err)
	}
